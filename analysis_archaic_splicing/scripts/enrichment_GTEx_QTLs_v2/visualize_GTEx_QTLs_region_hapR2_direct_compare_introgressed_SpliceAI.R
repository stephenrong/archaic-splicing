...
adaptive_enrichments_list[["weak"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/adaptive_spliceai_weak/adaptive_spliceai_weak_matched_EUR_AC_binxEUR_hapR2tag_bin_control_standard_SpliceAI-enrichment_score_table.txt"))
adaptive_enrichments_list[["moderate"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/adaptive_spliceai_moderate/adaptive_spliceai_moderate_matched_EUR_AC_binxEUR_hapR2tag_bin_control_standard_SpliceAI-enrichment_score_table.txt"))
adaptive_enrichments_list[["strong"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/adaptive_spliceai_strong/adaptive_spliceai_strong_matched_EUR_AC_binxEUR_hapR2tag_bin_control_standard_SpliceAI-enrichment_score_table.txt"))
adaptive_enrichments_list[["sig"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/adaptive_spliceai_sig/adaptive_spliceai_sig_matched_EUR_AC_binxEUR_hapR2tag_bin_control_standard_SpliceAI-enrichment_score_table.txt"))

archaic_enrichments_list <- list()
archaic_enrichments_list[["weak"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/introgressed_spliceai_weak/introgressed_spliceai_weak_matched_EUR_AC_binxEUR_hapR2tag_bin_control_standard_SpliceAI-enrichment_score_table.txt"))
archaic_enrichments_list[["moderate"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/introgressed_spliceai_moderate/introgressed_spliceai_moderate_matched_EUR_AC_binxEUR_hapR2tag_bin_control_standard_SpliceAI-enrichment_score_table.txt"))
archaic_enrichments_list[["strong"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/introgressed_spliceai_strong/introgressed_spliceai_strong_matched_EUR_AC_binxEUR_hapR2tag_bin_control_standard_SpliceAI-enrichment_score_table.txt"))
archaic_enrichments_list[["sig"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/introgressed_spliceai_sig/introgressed_spliceai_sig_matched_EUR_AC_binxEUR_hapR2tag_bin_control_standard_SpliceAI-enrichment_score_table.txt"))
...
ggsave("../../results/enrichment_GTEx_QTLs_v2/direct_compare/direct_compare_AF_LD_adaptive_vs_introgressed_SpliceAI_weak.pdf", device=cairo_pdf, scale=0.65)
...
ggboxplot(enrichments_final %>% filter(region=="moderate"), 
	...
	theme(legend.position = "none") + theme(aspect.ratio=1.5) + theme(plot.background=element_blank()) + 
	xlab("") + ylab("log2 odds-ratio") + theme(plot.margin = margin(0,0,0,1, "in")) + ylim(c(-1.5, 3.5))
ggsave("../../results/enrichment_GTEx_QTLs_v2/direct_compare/direct_compare_AF_LD_adaptive_vs_introgressed_SpliceAI_moderate.pdf", device=cairo_pdf, scale=0.65)
...
ggboxplot(enrichments_final %>% filter(region=="strong"), 
	...
	theme(legend.position = "none") + theme(aspect.ratio=1.5) + theme(plot.background=element_blank()) + 
	xlab("") + ylab("log2 odds-ratio") + theme(plot.margin = margin(0,0,0,1, "in")) + ylim(c(-1.5, 3.5))
ggsave("../../results/enrichment_GTEx_QTLs_v2/direct_compare/direct_compare_AF_LD_adaptive_vs_introgressed_SpliceAI_strong.pdf", device=cairo_pdf, scale=0.65)
...
ggboxplot(enrichments_final %>% filter(region=="sig"), 
	...
	theme(legend.position = "none") + theme(aspect.ratio=1.5) + theme(plot.background=element_blank()) + 
	xlab("") + ylab("log2 odds-ratio") + theme(plot.margin = margin(0,0,0,1, "in")) + ylim(c(-1.5, 3.5))
ggsave("../../results/enrichment_GTEx_QTLs_v2/direct_compare/direct_compare_AF_LD_adaptive_vs_introgressed_SpliceAI_sig.pdf", device=cairo_pdf, scale=0.65)
