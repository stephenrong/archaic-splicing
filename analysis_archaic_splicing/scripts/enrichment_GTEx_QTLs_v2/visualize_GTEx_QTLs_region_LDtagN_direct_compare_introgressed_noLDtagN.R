...
write_tsv(adaptive_enrichments_final, gzfile("../../results/enrichment_GTEx_QTLs_v2/figures/adaptively_introgressed-region-enrichment_scores_table_pivot_LDtagN_pointerror_direct_noLDtagN.txt.gz"))
...
write_tsv(archaic_enrichments_final, gzfile("../../results/enrichment_GTEx_QTLs_v2/figures/archaic_introgressed-region-enrichment_scores_table_pivot_LDtagN_pointerror_direct_noLDtagN.txt.gz"))
...
ggsave("../../results/enrichment_GTEx_QTLs_v2/direct_compare/direct_compare_AF_LDtagN_adaptive_vs_introgressed_eQTL_noLDtagN.pdf", device=cairo_pdf, scale=0.65)
...
ggboxplot(enrichments_final %>% filter(region=="sQTL"), 
	...
	theme(legend.position = "none") + theme(aspect.ratio=1.5) + theme(plot.background=element_blank()) + 
	xlab("") + ylab("log2 odds-ratio") + theme(plot.margin = margin(0,0,0,1, "in")) + ylim(c(-0.5, 1.5))
ggsave("../../results/enrichment_GTEx_QTLs_v2/direct_compare/direct_compare_AF_LDtagN_adaptive_vs_introgressed_sQTL_noLDtagN.pdf", device=cairo_pdf, scale=0.65)
