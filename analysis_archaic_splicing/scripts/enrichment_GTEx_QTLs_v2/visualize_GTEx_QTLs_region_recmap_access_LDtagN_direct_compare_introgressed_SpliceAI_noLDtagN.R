...
adaptive_enrichments_list[["weak"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/adaptive_spliceai_weak/adaptive_spliceai_weak_matched_EUR_AC_bin_control_recmap_access_SpliceAI-enrichment_score_table.txt"))
adaptive_enrichments_list[["moderate"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/adaptive_spliceai_moderate/adaptive_spliceai_moderate_matched_EUR_AC_bin_control_recmap_access_SpliceAI-enrichment_score_table.txt"))
adaptive_enrichments_list[["strong"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/adaptive_spliceai_strong/adaptive_spliceai_strong_matched_EUR_AC_bin_control_recmap_access_SpliceAI-enrichment_score_table.txt"))

archaic_enrichments_list <- list()
archaic_enrichments_list[["weak"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/introgressed_spliceai_weak/introgressed_spliceai_weak_matched_EUR_AC_bin_control_recmap_access_SpliceAI-enrichment_score_table.txt"))
archaic_enrichments_list[["moderate"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/introgressed_spliceai_moderate/introgressed_spliceai_moderate_matched_EUR_AC_bin_control_recmap_access_SpliceAI-enrichment_score_table.txt"))
archaic_enrichments_list[["strong"]] <- as_tibble(fread("../../results/enrichment_GTEx_QTLs_v2/introgressed_spliceai_strong/introgressed_spliceai_strong_matched_EUR_AC_bin_control_recmap_access_SpliceAI-enrichment_score_table.txt"))
...
ggsave("../../results/enrichment_GTEx_QTLs_v2/direct_compare/direct_compare_recmap_access_AF_LDtagN_adaptive_vs_introgressed_SpliceAI_weak_noLDtagN.pdf", device=cairo_pdf, scale=0.65)
...
ggboxplot(enrichments_final %>% filter(region=="moderate"), 
	...
	theme(legend.position = "none") + theme(aspect.ratio=1.5) + theme(plot.background=element_blank()) + 
	xlab("") + ylab("log2 odds-ratio") + theme(plot.margin = margin(0,0,0,1, "in")) + ylim(c(-2, 3.5))
ggsave("../../results/enrichment_GTEx_QTLs_v2/direct_compare/direct_compare_recmap_access_AF_LDtagN_adaptive_vs_introgressed_SpliceAI_moderate_noLDtagN.pdf", device=cairo_pdf, scale=0.65)
...
ggboxplot(enrichments_final %>% filter(region=="strong"), 
	...
	theme(legend.position = "none") + theme(aspect.ratio=1.5) + theme(plot.background=element_blank()) + 
	xlab("") + ylab("log2 odds-ratio") + theme(plot.margin = margin(0,0,0,1, "in")) + ylim(c(-2, 3.5))
ggsave("../../results/enrichment_GTEx_QTLs_v2/direct_compare/direct_compare_recmap_access_AF_LDtagN_adaptive_vs_introgressed_SpliceAI_strong_noLDtagN.pdf", device=cairo_pdf, scale=0.65)
