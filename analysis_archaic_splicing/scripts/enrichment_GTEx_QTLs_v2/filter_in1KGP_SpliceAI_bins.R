...
write_tsv(ALL_1KGP_phase3_MAF0.01_hapR2_hub_spliceai_gs_raw, gzfile("../../results/annotate_splice_prediction/ALL_1KGP_phase3_MAF0.01_hapR2_hub_spliceai_gs_raw.txt.gz"))
...
write_tsv(ALL_1KGP_phase3_MAF0.01_hapR2_hub_spliceai_gs_raw_dedup, gzfile("../../results/annotate_splice_prediction/ALL_1KGP_phase3_MAF0.01_hapR2_hub_spliceai_gs_raw_dedup.txt.gz"))
