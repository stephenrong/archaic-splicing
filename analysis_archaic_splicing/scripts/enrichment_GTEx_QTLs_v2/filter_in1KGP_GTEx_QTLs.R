...
# load 1KGP variants
ALL_1KGP_phase3_hapR2_hub <- as_tibble(fread("../../results/preprocess_1KGP_SNPs/ALL_1KGP_phase3_hapR2_hub.txt.gz"))
...
# join 1KGP variants
join_in1KGP_GTEx_aQTLs_hg19 <- collate_GTEx_aQTLs_hg19 %>% left_join(ALL_1KGP_phase3_hapR2_hub)
join_in1KGP_GTEx_sQTLs_hg19 <- collate_GTEx_sQTLs_hg19 %>% left_join(ALL_1KGP_phase3_hapR2_hub)
join_in1KGP_GTEx_eQTLs_hg19 <- collate_GTEx_eQTLs_hg19 %>% left_join(ALL_1KGP_phase3_hapR2_hub)
