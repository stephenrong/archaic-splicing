...
ALL_1KGP_phase3_greater0.9_gnomAD_file <- "../../results/preprocess_1KGP_SNPs/ALL_1KGP_phase3_greater0.9_gnomAD_file.vcf.gz"
ALL_1KGP_phase3_greater0.9_gnomAD_input <- read.vcfR(ALL_1KGP_phase3_greater0.9_gnomAD_file) %>% 
...
for (col in col_list) {
	let(c(VAR=col), 
		ALL_1KGP_phase3_greater0.9_gnomAD_input <- ALL_1KGP_phase3_greater0.9_gnomAD_input %>% 
			mutate(VAR = as.numeric(gsub(".*=", "", VAR))))
}
names(ALL_1KGP_phase3_greater0.9_gnomAD_input) <- 
...
ALL_1KGP_phase3_greater0.9_gnomAD_hub <- ALL_1KGP_phase3_greater0.9_hub %>% 
	left_join(ALL_1KGP_phase3_greater0.9_gnomAD_input)

# 	save file
print("gnomAD save file")
write_tsv(ALL_1KGP_phase3_greater0.9_gnomAD_hub, gzfile("../../results/preprocess_1KGP_SNPs/ALL_1KGP_phase3_greater0.9_gnomAD_hub.txt.gz"))

# 	check duplicates
print(table(table(ALL_1KGP_phase3_greater0.9_gnomAD_hub$hub_variant_ID)))
