...
supplement_annotations_hexamer_final <- supplement_annotations_hexamer %>% 
	dplyr::select(exon_gene_name,ss_strand,ss_wt_elevenmer,ss_mt_elevenmer,ss_EI_mt,ss_EI_wt,ss_EI,ss_exonicA3SS_mt,ss_exonicA3SS_wt,ss_exonicA3SS,ss_exonicA5SS_mt,ss_exonicA5SS_wt,ss_exonicA5SS,ss_intronicA3SS_mt,ss_intronicA3SS_wt,ss_intronicA3SS,ss_intronicA5SS_mt,ss_intronicA5SS_wt,ss_intronicA5SS) %>% 
...
supplement_annotations_vep_final <- supplement_annotations_vep %>% 
	dplyr::select(exon_gene_name,VEP) %>% 
...
supplement_annotations_spliceai_final <- supplement_annotations_spliceai %>% 
	dplyr::select(exon_gene_name,ALLELE,SYMBOL,DS_AG,DS_AL,DS_DG,DS_DL,DP_AG,DP_AL,DP_DG,DP_DL,spliceai_max) %>% 
